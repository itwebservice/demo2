...
<head>
    ...
    <title>Login</title>
    <meta name="description" content="Author: ITWEB Services-iTours, Category: Tours & Travels Product" />
        ...
        <div class="login_modal">
            ...
            <form id="frm_login" method='post'>
                <div class="login_form">
                    ...
                    <!-- **** Form Field :: Start **** -->
                    <div class="formField">
                        <input type="text" class="input-txtbox" placeholder="Enter Agent Code"
                            title="Please Enter Agent Code" id='agent_code' name='agent_code' required />
                    </div>
                    <div class="formField">
                        <input type="text" class="input-txtbox" placeholder="Enter User Name"
                            title="Please Enter User Name" id='user_name' name='user_name' required />
                    </div>
                    <div class="formField">
                        <input type="password" class="input-txtbox pass" placeholder="Enter Password"
                            title="Please Enter Password" id='password' name='password' required /><a
                            onclick="show_password('password')" target="_BLANK" class="btn app_btn"
                    ...
                    <div class="btnContainer type-link text-right">
                        <input type='button' class="btn-link bold underline" id='send_btn' onclick="open_modal();"
                    ...
                    <div class="btnContainer type-link text-center">
                        ...
                        <a class="btn-link bold underline" target='_blank'
                            href="../view/b2b_customer/registration/index.php">Register Here</a>
                    </div>
                    <!-- **** Register Button :: End **** -->
...
$('#frm_login').validate({
    ...
    submitHandler: function(form) {
        ...
        $.post('../controller/b2b_customer/login/login_verify.php', {
            ...
            if (data1[0] == "valid") {
                ...
                if (typeof Storage !== 'undefined') {
                    ...
                    if (localStorage) {
                        var cart_list_arr = (JSON.parse(data1[1]) == "") ? JSON.stringify([]) : JSON
                            .parse(data1[1]);
