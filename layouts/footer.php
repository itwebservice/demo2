  ...
  <footer class="c-footer">
      ...
      <div class="footer-wrapper">
          ...
          <div class="container">
              ...
              <div class="row">
                  ...
                  <div class="col-sm-5 col-md-3">
                      ...
                      <?php if($cached_array[0]->company_profile_data[0]->contact_no!='') { ?><p> <span
                              class="strong">Phone: </span> <span
                              class="highlighted"><?= $cached_array[0]->company_profile_data[0]->contact_no ?></span>
                      </p> <?php } ?>

                      <?php if($cached_array[0]->company_profile_data[0]->email_id!='') { ?><p> <span
                              class="strong">Email ID: </span> <span class="highlighted"><a
                                  href="mailto:<?= $cached_array[0]->company_profile_data[0]->email_id ?>"
                                  style="color: #838383;"><?= $cached_array[0]->company_profile_data[0]->email_id ?></span>
                      </p><?php } ?>
          ...
          ?>
                ...
                for($i=0;$i<sizeof($col3_tours);$i++){
                  ...
                  ?>
                          ...
                          <div class="row">
                              ...
                              <div class="col-md-12" style="padding: 0px!important;">
                                  ...
                                  <li><a target="_blank" href="<?= $file_name ?>"><?= $sq_package['package_name'] ?></a>
                                  </li>
                          ...
                          <div class="row">
                              <div class="col-md-12">
                                  ...
                                  <div class="col-md-12 col-lg-6" style="padding: 0px!important;">
                                      ...
                                      <li> <a target="_blank" href="<?=BASE_URL_B2C?>award.php"
                                              style="width: 100%;">Awards</a>
                                      </li>
                                  ...
                                  <div class="col-md-12 col-lg-6" style="padding: 0px!important;display: inline-block;">
                                      ...
                                      <li> <a target="_blank" href="<?=BASE_URL_B2C?>gallery.php"
                                              style="width: 100%;">Gallery</a>
                                      </li>
                          ...
                          <div class="row">
                              <div class="col-md-12">
                                  ...
                                  <div class="col-md-12 col-lg-6" style="padding: 0px!important;">
                                      ...
                                      <li> <a target="_blank" href="<?=BASE_URL_B2C?>blog.php"
                                              style="width: 100%;">Travel Blog</a>
                                      </li>
                                  ...
                                  <div class="col-md-12 col-lg-6" style="padding: 0px!important;display: inline-block;">
                                      ...
                                      <li> <a target="_blank" href="<?=BASE_URL_B2C?>testimonials.php"
                                              style="width: 100%;">Testimonials</a>
                                      </li>
                          ...
                          <div class="row">
                              <div class="col-md-12">
                                  ...
                                  <div class="col-md-12 col-lg-6" style="padding: 0px!important;">
                                      ...
                                      <li> <a target="_blank" href="<?=BASE_URL_B2C?>refund-policy.php"
                                              style="width: 100%;">Refund Policy</a>
                                      </li>
                                  ...
                                  <div class="col-md-12 col-lg-6" style="padding: 0px!important;display: inline-block;">
                                      ...
                                      <li> <a target="_blank" href="<?=BASE_URL_B2C?>privacy-policy.php"
                                              style="width: 100%;">Privacy Policy</a>
                                      </li>
                          ...
                          <div class="row">
                              <div class="col-md-12">
                                  ...
                                  <div class="col-md-12 col-lg-6" style="padding: 0px!important;">
                                      ...
                                      <li> <a target="_blank" href="<?=BASE_URL_B2C?>terms-conditions.php"
                                              style="width: 100%;">Terms of Use</a>
                                      </li>
                                  ...
                                  <div class="col-md-12 col-lg-6" style="padding: 0px!important;display: inline-block;">
                                      ...
                                      <li> <a target="_blank" href="<?=BASE_URL_B2C?>cancellation-policy.php"
                                              style="width: 100%;">Cancellation Policy</a> </li>
                  ...
                  if($social_media[0]->fb!=''){?><li><a target="_blank" href="<?= $social_media[0]->fb ?>"><i
                                      class="fa fa-facebook" aria-hidden="true"></i></a> </li><?php } ?>

                          <?php

                  if($social_media[0]->wa!=''){?><li><a target="_blank" href="<?= $social_media[0]->wa ?>"><i
                                      class="fa fa-whatsapp" aria-hidden="true"></i></a> </li><?php } ?>

                          <?php

                  if($social_media[0]->tw!=''){?><li><a target="_blank" href="<?= $social_media[0]->tw ?>"><i
                                      class="fa fa-twitter" aria-hidden="true"></i></a> </li><?php } ?>

                          <?php

                  if($social_media[0]->li!=''){?><li><a target="_blank" href="<?= $social_media[0]->li ?>"><i
                                      class="fa fa-linkedin" aria-hidden="true"></i></a> </li><?php } ?>

                          <?php

                  if($social_media[0]->yu!=''){?><li><a target="_blank" href="<?= $social_media[0]->yu ?>"><i
                                      class="fa fa-youtube" aria-hidden="true"></i></a> </li><?php } ?>

                          <?php

                  if($social_media[0]->inst!=''){?><li><a target="_blank" href="<?= $social_media[0]->inst ?>"><i
                                      class="fa fa-instagram" aria-hidden="true"></i></a> </li><?php } ?>
      ...
      <div class="ts-site-info">
          ...
          <div class="container">
              ...
              <p class="ts-site-info-text">© 2022 <a href="#"
                      style="text-decoration: none; color: inherit;"><?= $cached_array[0]->company_profile_data[0]->company_name?></a>.
