  ...
  <footer class="c-footer">
          ...
          <div class="container">
              ...
              <div class="row">
                  ...
                  <div class="col-sm-5 col-md-3">
                      ...
                      <?php if ($cached_array[0]->company_profile_data[0]->contact_no != '') { ?><p> <span class="strong">Phone: </span> <span class="highlighted"><?= $cached_array[0]->company_profile_data[0]->contact_no ?></span>
                          </p> <?php } ?>

                      <?php if ($cached_array[0]->company_profile_data[0]->email_id != '') { ?><p> <span class="strong">Email ID: </span> <span class="highlighted"><a href="mailto:<?= $cached_array[0]->company_profile_data[0]->email_id ?>" style="color: #838383;"><?= $cached_array[0]->company_profile_data[0]->email_id ?></a></span>
                          </p><?php } ?>
      ...
      <div class="ts-site-info">
          ...
          <div class="container">
              ...
              <p class="ts-site-info-text">© 2022 <a href="#" style="text-decoration: none; color: inherit;"><?= $cached_array[0]->company_profile_data[0]->company_name ?></a>.
